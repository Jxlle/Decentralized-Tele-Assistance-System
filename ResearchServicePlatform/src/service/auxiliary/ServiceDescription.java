...
public class ServiceDescription implements Serializable {
    ...
    /**
     * Return the linked service registry endpoint
     * @return the service registry endpoint
     */
    ...
    /**
     * Set the linked service registry endpoint
     * @param serviceRegistryEndpoint the service registry endpoint
     */
    public void setServiceRegistryEndpoint(String serviceRegistryEndpoint) {
    	this.serviceRegistryEndpoint = serviceRegistryEndpoint;
    }
    ...
    /**
     * Increase the service load
     * @param increaseAmount the amount that the load is increased by
     */
    public void increaseLoad(int increaseAmount) {
    	load += increaseAmount;
    }
    
    /**
     * Reset the service load
     */
