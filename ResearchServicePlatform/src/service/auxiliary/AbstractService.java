...
public abstract class AbstractService implements MessageReceiver {
    ...
    public void register(ServiceRegistry registry) {
    	this.sendRequest(registry.getServiceDescription().getServiceName(), registry.getServiceDescription().getServiceEndpoint(), true, "register", description);
     ...
     */
    public void unRegister(ServiceRegistry registry) {
    	this.sendRequest(registry.getServiceDescription().getServiceName(), registry.getServiceDescription().getServiceEndpoint(), true, "unRegister", this.description.getRegisterID());
    }

    /**
     * Helps to dynamically update the service description
     */
    public void updateServiceDescription(ServiceRegistry registry) {
    	if (description.getRegisterID() > 0)
    		this.sendRequest(registry.getServiceDescription().getServiceName(), registry.getServiceDescription().getServiceEndpoint(), true, "update", this.description);
    	else
